...
person_df1 <- read.csv(file='tidynomicon./person.csv')
str(person_df1)
...
person_df2 <- read.csv(file='tidynomicon./person.csv', stringsAsFactors = FALSE)
str(person_df2)
...
sheet_names <- excel_sheets('./G04ResultsDetail2004-11-02.xls')
sheet_names
